...
# find the directory where this specific file is
dir_path = os.path.dirname(os.path.realpath(__file__))

def main(input_file='pilatus800.jpg'):
    # print(dir_path)
 ...
 ############################################################
    ...
    img0 = PIL.Image.open(input_file)
...
if __name__ == '__main__':
    input_file = sys.argv[1] if len(sys.argv) >= 2 else 'pilatus800.jpg'
    main(input_file)
